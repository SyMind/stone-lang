        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2: throw new (_a.apply(errors_1.ParseError, [void 0, _d.sent()]))();
                    case 3:
                        _c = (_b = res).push;
    ...
    Repeat.prototype.parse = function (lexer, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.match(lexer)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.parser.parse(lexer)];
                    case 1:
                        t = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
                    case 4: return [2 /*return*/, this.factory.make(results)];
                }
            });
        });
    };
