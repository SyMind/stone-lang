...
var Lexer = /** @class */ (function () {
    ...
    Lexer.prototype.hasNextLine = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!this.hasNextLine()) return [3 /*break*/, 2];
    ...
    Lexer.prototype.addToken = function (lineNo, results) {
        if (results[2] != null) {
            var token = new NumToken(lineNo, parseInt(results[2], 10));
            this.queue.push(token);
        }
        else if (results[3] != null) {
            var raw = results[3];
            var str = raw.substring(1, raw.length - 1);
            var token = new StrToken(lineNo, str);
            this.queue.push(token);
        }
        else if (results[4] != null) {
            var token = new IdToken(lineNo, results[4]);
            this.queue.push(token);
        }
    };
    return Lexer;
