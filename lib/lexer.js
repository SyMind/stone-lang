...
var Lexer = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        if (_a.sent())
                            return [2 /*return*/, this.queue.pop()];
                        return [2 /*return*/, token_1.Token.EOF];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        throw new parseError_1.ParseError(error_1.message);
                    case 3:
                        if (line == null) {
                            return [2 /*return*/];
                        }
    ...
    Lexer.prototype.addToken = function (lineNo, results) {
        ...
        var token;
        if (results[2] != null) {
            token = new token_1.NumToken(lineNo, parseInt(results[2], 10));
        }
        else if (results[3] != null) {
            var raw = results[3];
            var str = raw.substring(1, raw.length - 1);
            token = new token_1.StrToken(lineNo, str);
        }
        else if (results[4] != null) {
            token = new token_1.IdToken(lineNo, results[4]);
        }
